...
class RecentMatchesJobDetails extends Component {    
    render(){       
        return(
            <Fragment>
                        ...
                        <div className="row">
                            ...
                            <div className="col-md-6">
                                <div  className="content_headings">
                                    ...
                                    <h6>Others</h6>
                                    <div className="row">
                                        <div className="col-md-5 others_section_firstcol">
                                            <div>Working Hours</div>
                                        </div>
                                        <div className="col-md-6 others_section_secondcol">
...
export default RecentMatchesJobDetails
