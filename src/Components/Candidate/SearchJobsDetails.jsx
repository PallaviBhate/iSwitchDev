...
class SearchJobsdetails extends Component {    
    render(){
        return(
            <Fragment>
                ...
                <div className="container-fluid">            
                    <div aria-label="breadcrumb">
                        <ol class="breadcrumb">
                            ...
                            <Link to ="/candidate/searchJobs">Job Listings</Link></li>
                            <li class="breadcrumb-item active" aria-current="page">Search Job Details</li>
                        </ol>
                    </div>               
