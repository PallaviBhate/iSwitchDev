        ...
        <div class="mb-4">
          ...
          {!isSchoolEducation ? <div>
            <div className="form-group">
              ...
              <input class="form-control" type="text" name="course"  value={inputData.course}
            ...
            <div className="form-group">
              ...
              <input class="form-control" type="text" name="specialization"  value={inputData.specialization}
