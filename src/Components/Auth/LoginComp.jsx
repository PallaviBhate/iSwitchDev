...
class Login1 extends Component{
  ...
  // get DOM elements
    ...
    rememberMeHandle=(event)=>{
      ...
      this.setState({
        [input.name]:value},  () => { this.validateField(input.name, value)});
    }
      ...
      //Referance from Login html
          <div class="container-fluid pl-0 pr-0">
            <div class="SideNav" id="mySidenav">
              <a href="javascript:void(0)" class="hamburger" id="hamburger" onClick={() => this.openNav()}>&#9776;</a>
                <div id="sidenavOptions" style={{display: 'none' }}>
          ...
          <div class="Main_Container row ml-0" id="main">
            <div class="Header login_header_bottom">
              <ul>
                <li><img src="assets/login/iconfinder_phone.svg"/><span class="header_telephone marL5">58000 45000</span></li>
                <li class="marL0 marR0">|</li>
                <li><img src="assets/login/iconfinder_icon-email_211660.svg"/><a href="https://mail.google.com/mail/?view=cm&fs=1&to=info@jobzilla.com&su=SUBJECT&body=BODY" target="_blank"><span class="header_email marL5"></span>info@jobzilla.com</a></li>
              </ul>
            </div>
              ...
              <form class="">
                <FormErrors formErrors={this.state.formErrors} />
					      ...
					      <div class="wid100 float-left marT30 marB20" >
						      <button class=" btn btn_login mr-4" onClick={() => this.onLogin()} disabled={!this.state.formValid} name="">Login</button>
