                        ...
                        <form className="mt-4" onSubmit={this.submituserRegistrationForm} autoComplete="off">
                            <div className="signUp_left">
                                ...
                                <div id="" className="marT10 float-container form-group">
                                    ...
                                    <input type="text" id="signup_name_floatField" className="" name="contact_person_name" data-placeholder="Contact Person's Name" value={this.state.fields.contact_person_name} onChange={ (e) => {this.handleChange(e);this.validateForm();} } 
                                    onBlur = {(e) => {this.handleTouch(e);this.validateForm();} }   />
                                    {
                                       this.state.formSubmitted || this.state.touched.contact_person_name?
